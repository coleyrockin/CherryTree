...
const EXPECTED_DESCRIPTION =
  "A seven-scene, scroll-driven cinematic gallery with real-time WebGL petals.";
...
const checkSceneConsistency = () => {
  ...
  check(readme.includes("seven scenes"), "README should describe seven scenes");
  check(!manifest.description.includes("six scenes"), "manifest should not describe six scenes");
  check(manifest.description.includes("seven scenes"), "manifest should describe seven scenes");
};
